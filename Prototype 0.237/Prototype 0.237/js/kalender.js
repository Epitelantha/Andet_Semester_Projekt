$(document).ready(function() {
    ...
    BookingKalender.prototype.opretBooking = function(e, group) {
        ...
        var end = (Math.floor(time / 60) + 1 ) + ":" + minutes;
        
        var listItem = $('<li class="single-event" data-start="' + start +'" data-end="' + end + '"  data-content="event-rowing-workout" data-event="event-2"><a href="#0"><em class="event-name">Book en tid</em></a></li>');
